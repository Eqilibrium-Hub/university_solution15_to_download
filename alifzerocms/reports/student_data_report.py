...
class ReportStudentData(models.AbstractModel):
    _name = 'report.alifzerocms.report_student_data'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        students = self.env['alifzerocms.student'].browse(docids)
      
        report = self.env['ir.actions.report']._get_report_from_name('alifzerocms.alifzerocms.report_student_data')
        docargs = {
            # 'doc_ids': docids,
            'students': students,
