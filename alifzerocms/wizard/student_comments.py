...
class alifzerocmsStudentCommentWiz(models.TransientModel):
	_name ='alifzerocms.student.comment.wiz'
	...
	def add_comments(self):
		...
		student_comments = self.env['alifzerocms.student.comment']
		...
		for student in self.student_ids:
			...
			student_comments += self.env['alifzerocms.student.comment'].create(data)
		...
		return {
			...
			'view_mode': 'tree,form',
			'res_model': 'alifzerocms.student.comment',
			'view_id': False,
