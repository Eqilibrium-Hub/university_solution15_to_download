//odoo.define('alifzerocms_admission_portal.Dashboard', function (require) {
//"use strict";
//
...
//    cssLibs: [
//        '/alifzerocms_admission_portal/static/src/css/lib/nv.d3.css'
//    ],
//    jsLibs: [
//        '/alifzerocms_admission_portal/static/src/js/lib/d3.min.js'
//    ],
//    events: {
...
//                res_model: 'alifzerocms.application',
//                view_mode: 'tree,form',
//                view_type: 'form',
...
//                domain: [['step','=', 'Invoice Downloaded']],
//                target: 'current'
//            }, options)
//        });
//    },
...
//            self.do_action({
//                name: _t("Application Processing Fee Submitted"),
//                type: 'ir.actions.act_window',
//                res_model: 'alifzerocms.application',
//                view_mode: 'tree,form',
//                view_type: 'form',
//                views: [[a3, 'list'],[false, 'form']],
//                domain: [['step','=', 'Invoice Uploaded']],
//                target: 'current'
//            }, options)
//        });
//    },
...
//                domain: [['step','=', 'Voucher UnVerified']],
//                target: 'current'
//            }, options)
//        });
//    },
